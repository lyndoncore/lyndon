// Event Handler to make the sidenav sticky function run
window.onscroll = function() {myFunction()};

// Scroll sidenav sticky function
function myFunction() {
    if (document.body.scrollTop > 262 || document.documentElement.scrollTop > 262) {
        document.getElementById("sidebar").className = "nav--fixed";
    } else {
...
function toggleDropdown() {
	console.log("hello");
    document.getElementById("subnav").classList.toggle("subnav--m--open");
    document.getElementById("subnav").classList.toggle("subnav--m");
}
